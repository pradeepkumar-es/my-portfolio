  ...
  return (
    <div className='contact'>
      <div className="contactinfo">
        ...
        <p><MdEmail/>&nbsp;<a style={{textDecoration:"none"}} href="mailto:pradeepkumariitk22@gmail.com?subject=Contact For&body=Hi Pradeep,">pradeepkumariitk22@gmail.com</a></p>
      </div>
      <div className="contactform">
        <form className='form' action="">
          <label htmlFor="name"> Your Name <br /><input type='text' name="name" id="name" placeholder='Your Name'required/></label>
