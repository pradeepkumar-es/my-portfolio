...
import pradeepProfile from "../images/pradeep-nobg.png";
...
export default function Home() {
  ...
  useEffect(() => {
    if (locationObject.hash) {
      document
        .querySelector(locationObject.hash)
      ...
      <div className="home">
        <div id="about" className="introduction">
          <div className="about">
            ...
            <img
              id="pradeep-profile"
              src={pradeepProfile}
              alt="Profile of Pradeep"
            />
            <h3 className="name">
              Pradeep Kumar<div className="shdash"></div>
            </h3>
            {/* <h1 id="aboutme">Elevating Brands Through Innovative Web Solutions</h1> */}
            <p>
              B.Tech graduate from IIT Kanpur specializing in frontend
              development, with experience building responsive React
              applications, REST API integrations, and full-stack web solutions.
            </p>
        ...
        <div id="experience" className="journey">
          <h1 className="sectionTitle">
            <MdWorkHistory style={{ width: "2.5rem", height: "2.5rem" }} />{" "}
            &nbsp;Work Experience
          </h1>
          <div className="journeySection">
            <div className="path">{/* <MovingElement/> */}</div>
            <div className="jcard">
        ...
        <div id="education" className="journey">
          <h1 className="sectionTitle">
            <IoSchool style={{ width: "2.5rem", height: "2.5rem" }} />{" "}
            &nbsp;Education
          </h1>
          <div className="journeySection">
            <div className="path">{/* <MovingElement/> */}</div>
        ...
        <div id="skills" className="skills">
          <h1 className="sectionTitle">
            <GrUserExpert style={{ width: "2.5rem", height: "2.5rem" }} />
            &nbsp;Skills
          </h1>
        ...
        <div id="myproject" className="myproject">
          <h1 className="sectionTitle">
            <GoProjectSymlink style={{ width: "2.5rem", height: "2.5rem" }} />
            &nbsp;Projects
          </h1>
        ...
        <div id="resume" className="resume-preview">
          <h1 className="sectionTitle">
            <MdDescription style={{ width: "2.5rem", height: "2.5rem" }} />
            &nbsp;Resume
          </h1>
          <div className="resume-box">
            <div className="resume-box-text">
              ...
              <p>
                Recent graduate from IIT Kanpur with experience in building
                modern web apps, responsive interfaces, and full-stack product
                features.
              </p>
            </div>
            ...
            <div className="resume-actions-home">
              <a
                href="https://drive.google.com/file/d/1J9zVpu8PvgFsSmLaQ211JrCU-R2sMq0h/view?usp=drive_link"
                target="_blank"
                rel="noreferrer"
              >
                View Resume
              ...
              <a
                href="https://drive.google.com/uc?export=download&id=1J9zVpu8PvgFsSmLaQ211JrCU-R2sMq0h"
                target="_blank"
                rel="noreferrer"
              >
                Download Resume
        ...
        <div id="contact" className="contactme">
          <h1 className="sectionTitle">
            <i style={{ verticalAlign: "middle" }}>
              <MdEmail style={{ width: "2.6rem", height: "2.6rem" }} />
            </i>
            &nbsp;Contact Me
          </h1>
